...
- **Desktop**: XFCE
- **IDEs**:
  + Eclipse (version 4.37.0) for Java
  + IntelliJ (IDEA Community Edition, version 2025.2.1) for Java/Kotlin
  + CLion (version 2025.2.1) for C/C++
  + Pycharm Community Edition Python IDE (version  2025.2.1) for Python
  + VS Code(version 1.105.0) for Java, C/C++
- **Editors**:
  + vi/vim
  + gvim
  + emacs
...
- **Programming Languages**:
  + Java: Openjdk 21.0.8
  + C/C++: gcc/g++  13.3.0
  + Python: PyPy 7.3.18 with GCC 10.2.1 providing python 3.11.11
  + Kotlin: Kotlin 1.9.24

## Additional Items

Contestants may also bring the following items to their work station. Contestants must bring these items to the dress rehearsal (Saturday, 7th March 2026), and leave it on the work station at the end of the dress rehearsal.
...
+ Hygiene products (e.g., tissues, hand sanitizer, menstrual products, masks, and basic medical supplies) are allowed provided they do not disturb other teams.
+ Personal medicines

All the items are subject to the judges, marshals, and contest staffs' inspection after the dress rehearsal. Please note that all items should not disturb other teams in any form, including noise, smell, culturally insensitive contents, and other things. No other materials are allowed to be in the work station.
...
- During dress rehearsal:
  ...
  + Bottle water is provided at the designated area.
- During the championship:
  + Light sandwiches and packet drinks are provided at the designated area.
  + Bottle water is provided at the designated area.
- Unfinished food, drink, and bottled water should be properly labelled. Labelled stickers will be provided in the snack area.
